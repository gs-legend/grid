...
var ComboChartProxy = /** @class */ (function (_super) {
    ...
    ComboChartProxy.prototype.getAxes = function (updateParams) {
        ...
        var bottomOptions = object_1.deepMerge(axisOptions[this.xAxisType], axisOptions[this.xAxisType].bottom);
        var leftOptions = object_1.deepMerge(axisOptions[this.yAxisType], axisOptions[this.yAxisType].left);
        var rightOptions = object_1.deepMerge(axisOptions[this.yAxisType], axisOptions[this.yAxisType].right);
        var primaryYKeys = [];
        var secondaryYKeys = [];
